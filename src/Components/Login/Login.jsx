...
const Login = ({ switchRegister, handlePopupToggle }) => {
                ...
                <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 shadow-md bg-white rounded-md duration-200 w-[520px] relative overflow-hidden'>
                    ...
                    <div className=''>
                        ...
                        <div className='flex justify-center items-center gap-1 my-8'>
                            ...
                            <a href="#" className='text-secondary text-base font-semibold hover:text-secondary/60' onClick={switchRegister}>Sign Up</a>
                        </div>
                    </div>
                </div>
            </div>
